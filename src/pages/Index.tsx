...
const Index = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  (props, ref) => {
    ...
    return (
      <div ref={ref} className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-900 via-purple-800 to-indigo-700" {...props}>
        <div className="w-full max-w-4xl">
          <div className="text-center mb-12">
            <h1 className="text-6xl font-bold text-white mb-4 opacity-0 animate-fade-in">
              EthioQuiz 2050 for Haramaya Highschool and Secondary Students
            </h1>
